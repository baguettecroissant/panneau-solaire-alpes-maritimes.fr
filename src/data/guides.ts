...
export const guides: Guide[] = [
	{
		slug: 'prix-panneaux-solaires-premium-06',
		title: 'Prix des panneaux solaires premium dans les Alpes-Maritimes en 2026 : comparatif 3, 6, 9 et 12 kWc',
		shortTitle: 'Prix premium 3 à 12 kWc dans le 06',
		description: 'Prix 2026 d’une installation solaire en Alpes-Maritimes : comparaison 3, 6 et 9 kWc, production, équipements et rentabilité.',
		category: 'Prix',
		readTime: '8 min',
		image: '/images/guide-prix-alpes-maritimes.png',
		intro: 'Le prix utile n’est jamais celui d’un panneau isolé. Il faut comparer une centrale livrée, raccordée et documentée : modules, électronique de puissance, système de fixation, protections électriques, accès au suivi, démarches et garanties. En Alpes-Maritimes, l’ensoleillement est favorable, mais il ne compense ni une toiture mal étudiée ni une puissance choisie uniquement pour remplir le pan disponible. Les fourchettes ci-dessous sont des repères de marché, à confirmer par des devis datés et comparables.',
		sections: [
			{
				heading: '3, 6 ou 9 kWc : partir des usages, pas de la surface',
				paragraphs: [
					'Un projet de 3 kWc répond souvent à une maison sobre, chauffée autrement qu’à l’électricité, avec une présence en journée ou quelques appareils programmables. En configuration simple, une enveloppe indicative de 8 500 à 11 000 € TTC permet de situer les devis, sans constituer un tarif officiel. La surface nécessaire dépend de la puissance unitaire des modules et de leur calepinage.',
					'Une installation de 6 kWc devient cohérente avec une famille équipée, une piscine, une pompe à chaleur, une climatisation ou une recharge de véhicule pilotée. Une enveloppe de 14 000 à 18 000 € TTC est un ordre de grandeur, tandis que 9 kWc peut se situer autour de 18 000 à 24 000 € TTC. Une charpente complexe, un accès difficile, une reprise électrique ou un stockage font varier ces repères.'
				],
				bullets: [
		...
		faqs: [
			['Quel budget retenir pour 6 kWc à Nice ?', 'Pour une toiture simple, 14 000 à 18 000 € TTC constitue un repère indicatif, pas un barème. L’accès, la couverture, l’électronique, les protections et les démarches peuvent déplacer cette fourchette. Comparez des devis après visite avec un périmètre identique.'],
	...
	{
		slug: 'autoconsommation-solaire-nice',
		title: 'Autoconsommation solaire à Nice : une décision rationnelle et mesurable',
		shortTitle: 'Autoconsommation à Nice',
		description: 'Comprendre et optimiser l’autoconsommation solaire à Nice : taux de couverture, pilotage, surplus, batterie et dimensionnement.',
		category: 'Autoconsommation',
		readTime: '8 min',
		image: '/images/guide-autoconsommation-nice.png',
		intro: 'À Nice, une installation photovoltaïque produit surtout entre la fin de matinée et l’après-midi, avec un profil saisonnier marqué. L’objectif n’est donc pas de battre un record annuel, mais de faire coïncider la production avec des besoins utiles. Cette démarche commence par deux indicateurs correctement distingués, se poursuit par un dimensionnement mesuré et s’améliore souvent davantage grâce au pilotage qu’avec une batterie achetée trop tôt.',
		sections: [
			{
		...
		faqs: [
			['Quel taux d’autoconsommation viser à Nice ?', 'Il n’existe pas de cible universelle. Sans batterie, de nombreux projets se situent entre 35 et 60 %, mais le résultat dépend du profil horaire et de la puissance. Une étude doit privilégier l’économie réelle, pas un pourcentage flatteur obtenu avec une centrale trop petite.'],
	...
	},
	{
		...
		faqs: [
			['Quel temps de retour attendre en Alpes-Maritimes ?', 'Il dépend du prix installé, de la production, de l’autoconsommation et du financement. Une plage de sept à onze ans est parfois observée sur des projets cohérents, mais elle ne remplace pas un calcul individuel. Testez aussi un scénario dégradé avant de décider.'],
	...
	{
		slug: 'aides-solaire-2026-alpes-maritimes',
		title: 'Aides financières pour le solaire en 2026 dans le 06 : ce qui s’applique vraiment',
		shortTitle: 'Aides solaires 2026 dans le 06',
		description: 'Prime à l’autoconsommation, EDF OA, TVA et aides solaire 2026 en Alpes-Maritimes : conditions, montants et pièges à éviter.',
		category: 'Aides',
		readTime: '9 min',
		image: '/images/guide-aides-solaires-2026.png',
		path: '/aides-panneau-solaire-06',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Une commune, une intercommunalité, le Département ou la Région peuvent ouvrir, modifier ou fermer un programme. Il n’existe pas une « aide Alpes-Maritimes » permanente à présumer pour chaque foyer. Consultez les sites officiels de la collectivité concernée et France Rénov’, puis demandez une confirmation écrite indiquant la date, le budget disponible et la compatibilité avec les autres dispositifs.',
	...
	{
		slug: 'panneaux-full-black-villa-cote-azur',
		title: 'Panneaux full black sur une villa de la Côte d’Azur : esthétique, patrimoine et règles ABF',
		shortTitle: 'Full black & patrimoine azuréen',
		description: 'Installer des panneaux solaires à Nice en secteur patrimonial : déclaration préalable, ABF, panneaux full black et intégration aux villas azuréennes.',
		category: 'Patrimoine',
		readTime: '9 min',
		image: '/images/guide-patrimoine-cote-azur.png',
		intro: 'À Nice, la valeur d’un projet solaire se mesure aussi à sa discrétion. Le périmètre UNESCO, les abords de monuments historiques, les quartiers de villas Belle Époque et certaines perspectives urbaines imposent une lecture précise de la parcelle. Un refus n’est ni automatique ni impossible : la réussite dépend d’un diagnostic réglementaire précoce, d’un calepinage sobre et d’un dossier qui montre le bâtiment depuis l’espace public. L’urbanisme doit être résolu avant de promettre une production ou une date de chantier.',
		sections: [
			{
	...
	{
		slug: 'solaire-piscine-clim-voiture-electrique',
		title: 'Solaire, piscine, climatisation et voiture électrique : concevoir la villa complète dans le 06',
		shortTitle: 'Piscine, clim et voiture électrique',
		description: 'Dimensionner le photovoltaïque d’une villa des Alpes-Maritimes avec piscine, climatisation, borne de recharge et pilotage intelligent.',
		category: 'Villa connectée',
		readTime: '9 min',
		image: '/images/guide-villa-piscine-ve.png',
		intro: 'Dans les Alpes-Maritimes, piscine, climatisation et mobilité électrique peuvent devenir les meilleurs alliés du photovoltaïque : leurs besoins se concentrent en grande partie quand le soleil produit. L’enjeu n’est pourtant pas d’empiler les équipements. Il faut mesurer leur puissance, organiser leur simultanéité, tester plusieurs scénarios de centrale et conserver une marge d’évolution. Cette méthode transforme une villa fortement équipée en système énergétique cohérent plutôt qu’en collection d’appareils connectés.',
		sections: [
			{ heading: 'Cartographier chaque usage avant de choisir la puissance', paragraphs: ['Commencez par douze mois de consommation et, si possible, la courbe horaire du compteur. Séparez le talon permanent, la filtration de piscine, les cycles de climatisation, l’eau chaude, la recharge du véhicule et les usages du soir. Une facture annuelle ne montre ni les pointes ni les heures où plusieurs équipements fonctionnent ensemble.', 'Ajoutez les projets futurs sans les considérer comme certains. Une seconde voiture électrique, une pompe à chaleur pour la piscine ou une extension de climatisation se teste dans un scénario distinct. Le dimensionnement de base doit rester pertinent même si cet équipement est reporté.'], bullets: ['Consommation annuelle et courbe horaire.', 'Puissance de filtration et durée quotidienne.', 'Nombre de zones climatisées et saison d’usage.', 'Kilométrage électrique et horaires de présence.'] },
			{ heading: 'Faire travailler la piscine pendant le plateau solaire', paragraphs: ['La filtration est un usage flexible : sa durée dépend de la température de l’eau et des recommandations de traitement, mais ses horaires peuvent généralement être déplacés vers la fin de matinée et l’après-midi. Un gestionnaire d’énergie peut renforcer la filtration ou le chauffage lorsque le surplus dépasse un seuil.', 'Le pilotage ne doit jamais dégrader la qualité de l’eau. Les cycles indispensables restent prioritaires et le solaire vient optimiser leur horaire. Mesurez la puissance réelle de la pompe ; un équipement à vitesse variable offre souvent plus de souplesse qu’un fonctionnement tout ou rien.'] },
			{ heading: 'Climatiser intelligemment sans créer une consommation artificielle', paragraphs: ['La climatisation coïncide naturellement avec les journées de forte production. Une pré-climatisation raisonnable peut profiter du soleil avant le retour des occupants, à condition de conserver des consignes de confort sobres et de tenir compte de l’inertie du bâtiment.', 'L’étude doit distinguer puissance électrique absorbée et puissance thermique annoncée. Plusieurs groupes démarrant ensemble peuvent créer une pointe supérieure à la production instantanée. Un séquencement ou une régulation par zone limite cet effet sans imposer une centrale surdimensionnée.'] },
			{ heading: 'Recharger la voiture avec le surplus disponible', paragraphs: ['Une borne modulante adapte la charge au surplus photovoltaïque et évite de prélever inutilement sur le réseau. Une simple programmation de la recharge en journée peut déjà apporter une grande partie du bénéfice lorsque le véhicule reste à domicile.', 'Le besoin énergétique se calcule à partir des kilomètres réellement parcourus, pas de la capacité totale de la batterie. Vérifiez aussi monophasé ou triphasé, puissance souscrite et limite du point de livraison. La borne doit rester capable de garantir un niveau de charge minimal quand un départ est prévu.'], bullets: ['Mode surplus pour les journées ordinaires.', 'Charge minimale garantie avant un départ.', 'Délestage en fonction des autres usages.', 'Accès propriétaire aux données de recharge.'] },
			{ heading: 'Tester 6, 9 et 12 kWc avec les mêmes hypothèses', paragraphs: ['Comparez plusieurs puissances avec la même météo, les mêmes ombres et la même courbe de charge. Pour chaque variante, affichez production mensuelle, autoconsommation, injection, achats réseau et puissance maximale appelée. La meilleure centrale n’est pas nécessairement celle qui produit le plus.', 'Dans une villa avec piscine et véhicule, 9 kWc peut représenter un équilibre fréquent ; 12 kWc devient pertinent lorsque la consommation diurne et la surface réellement exploitable le justifient. Le budget doit intégrer raccordement, protections et éventuel passage en triphasé.'] },
			{ heading: 'Ajouter une batterie seulement après le pilotage', paragraphs: ['Piscine, eau chaude, climatisation et voiture sont déjà des formes de stockage ou de flexibilité. Exploitez-les avant d’acheter une batterie stationnaire. Le surplus restant et la consommation stable du soir déterminent ensuite si 5, 10 ou 15 kWh utiles sont cohérents.', 'Une fonction de secours doit être explicitement conçue : circuits prioritaires, puissance de sortie, commutation et recharge en mode isolé. Une batterie raccordée à un onduleur hybride ne garantit pas à elle seule que toute la villa restera alimentée lors d’une coupure.'] },
			{ heading: 'Superviser la villa comme un seul système', paragraphs: ['Le tableau de bord doit réunir production, import, export, batterie, piscine, borne et principaux groupes de climatisation. Des écrans séparés rendent le diagnostic difficile et encouragent des automatismes contradictoires. Exigez un accès administrateur au nom du propriétaire.', 'Après une année, comparez prévision et réalité mois par mois. Ajustez horaires, seuils et priorités avant d’envisager une extension. La valeur du système vient autant de la qualité du pilotage et du suivi que du rendement nominal des panneaux.'] }
		],
		faqs: [
			['Quelle puissance solaire pour une villa avec piscine et voiture électrique ?', 'Il faut mesurer les usages, mais 6 à 9 kWc constitue souvent le premier périmètre à tester. Une grande villa avec plusieurs véhicules, climatisation étendue et forte consommation de journée peut justifier 12 kWc.'],
			['Faut-il faire fonctionner la piscine uniquement quand il y a du soleil ?', 'Non. La qualité de l’eau et les cycles requis restent prioritaires. Le pilotage déplace la part flexible de la filtration vers le plateau solaire sans supprimer les besoins indispensables.'],
			['Une batterie est-elle obligatoire pour recharger la voiture au solaire ?', 'Non. Une borne modulante peut envoyer directement le surplus vers le véhicule. Une batterie stationnaire sert surtout à déplacer l’énergie vers le soir ou à assurer des circuits de secours lorsqu’elle est conçue pour cela.']
		]
	},
	{
		slug: 'installateur-solaire-rge-qualipv-06',
		title: 'Choisir un installateur solaire RGE QualiPV en Alpes-Maritimes',
		shortTitle: 'Choisir un installateur QualiPV',
		description: 'Les critères pour sélectionner un installateur photovoltaïque RGE QualiPV dans le 06 : assurances, étude, matériel, garanties et service.',
		category: 'Installateur',
		readTime: '9 min',
		image: '/images/guide-installateur-rge.png',
		intro: 'Choisir un installateur solaire en Alpes-Maritimes revient à confier simultanément toiture, électricité, démarches et performance à une entreprise. Le logo RGE est un filtre nécessaire pour certains dispositifs, pas une garantie absolue de qualité. La bonne sélection repose sur des vérifications simples, une visite technique, une étude explicable et un contrat qui nomme les responsabilités. Deux ou trois offres comparables valent mieux qu’une dizaine de simulations automatiques sans inspection du bâtiment.',
		sections: [
			{
